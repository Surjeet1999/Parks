...
public class ParksFragment extends Fragment implements OnParkClickListener{
    ...
    public ParksFragment() {
        // Required empty public constructor to use it as the Fragment
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // here we are getting the ParkViewModel class handle here
    ...
    public void onParkClicked(Park park) {
        ...
        getFragmentManager().beginTransaction()
                ...
                .commit();
        // DetailsFragment.newInstance() creates a new Fragment which is empty at the starting
    }
}